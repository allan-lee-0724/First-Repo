public abstract class Food {
     ...
     * of the abstract class and create an object of that sub-class to access the properties of the abstract
     * class
     */
     ...
     public Food(String name, String taste, int calorieCount, boolean isCandy, boolean isCooked, String texture, String smell){
        this.name = name;
        this.taste = taste;
