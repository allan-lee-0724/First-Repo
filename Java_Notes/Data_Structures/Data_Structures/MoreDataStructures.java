...
// their information cannot be found in the package (think folder with .java files) our current file is
// located in

public class MoreDataStructures {
    /*
     * Two interfaces you are going to want to become familiar with are the List and Set interface. These two
     ...
     */
     ...
     public static void main(String[] args) {
         ...
         * in the list will be adjusted according
         */
