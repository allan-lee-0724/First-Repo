    ...
    public static void main(String[] args) {
         ...
         */
         ...
         for(int x = 0; x < noWordsYet.length; x++){
             ...
             * 1. The value of characters is being concetenated with itself, so "abcd" is being put with "abcd"
             ...
             * It is important to realize that the initially created string did not change: it was used to create
             * string value and then it lost its previous reference (characters the variable).
             */
            characters += characters; // this replaces the old string value with a brand new one
         }
